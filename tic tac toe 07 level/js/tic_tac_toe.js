...
const msgtxt1 = '<p class="image"><img src ="img/pochita.jpg" width=61px height=61px></p><p class="text">Pochita Attack!(your turn)</p>';
const msgtxt2 = '<p class="image"><img src ="img/denji.jpg" width=61px height=61px></p><p class="text">Denshi Attack!(computer turn)</p>';
const msgtxt3 = '<p class="image"><img src ="img/pochita.jpg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInRight">Pochita Win!</p>';
const msgtxt4 = '<p class="image"><img src ="img/denji.jpg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInLeft">Denji Win!</p>';
const msgtxt5 = '<p class="image"><img src ="img/pochita.jpg" width=61px height=61px><img src = "img/denji.jpg" width=61px height=61px></P><p class="text animate__bounceIn">Draw!!</p>';

let gameSound = ["sound/sound1.mp3", "sound/sound2.mp3", "sound/pochitawin.mp3", "sound/denjiwin.mp3", "sound/draw.mp3"];
